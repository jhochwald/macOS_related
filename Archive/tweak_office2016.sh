...
if [[ -e "/Applications/Office/Microsoft Excel.app" ]]; then
	app=Excel
	DisableOffice2016FirstRun
fi

if [[ -e "/Applications/Office/Microsoft OneNote.app" ]]; then
	app=onenote.mac
	DisableOffice2016FirstRun
fi

if [[ -e "/Applications/Office/Microsoft Outlook.app" ]]; then
	app=Outlook
	DisableOffice2016FirstRun
fi

if [[ -e "/Applications/Office/Microsoft PowerPoint.app" ]]; then
	app=Powerpoint
	DisableOffice2016FirstRun
fi

if [[ -e "/Applications/Office/Microsoft Word.app" ]]; then
	app=Word
	DisableOffice2016FirstRun
fi
